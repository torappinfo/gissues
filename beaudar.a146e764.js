...
var CommentComponent = function () {
  function CommentComponent(comment, CommentAuthor, currentUser, locked) {
...
var TimelineComponent = function () {
  ...
  TimelineComponent.prototype.insertComment = function (comment, CommentAuthor, incrementCount) {
    var component = new _commentComponent.CommentComponent(comment, CommentAuthor, this.user ? this.user.login : null, this.issue.locked);
...
var NewCommentComponent = function () {
  ...
  NewCommentComponent.prototype.setUser = function (user) {
    ...
    if (user) {
      ...
      this.avatar.src = 'https://gissues.gitee.io/docs/logo/logo.svg';
      this.textarea.disabled = true;
        ...
        case 0:
          renderPage = function renderPage(page) {
            for (var _i = 0, page_2 = page; _i < page_2.length; _i++) {
              ...
              timeline.insertComment(comment, issue.user.login, false);
            }
          };
