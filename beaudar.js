parcelRequire = function(e) {
 ...
 return f(j("search/issues?q=" + encodeURIComponent(n) + "&repo="+ encodeURIComponent(h) +"&author="+ g +"%2F"+ h +"&page=1&per_page=1&order=asc")).then(function(n) {
 if (void 0 === n || !n.ok)
 ...
 o.innerHTML = "\n <a href=\"https://gissues.gitee.io\" target=\"_blank\">\n <img width=\"50px\" height=\"50px\" src=\"/logo.png\" alt=\"Beaudar(\u8868\u8FBE)\" title=\"Beaudar(\u8868\u8FBE)\">\n </a>",
 t.appendChild(o)),
 n.then(function() {
 ...
 case 5:
 throw n = s.sent(),
 new x().createMsgElement("gitee.com \u8BF7\u6C42\u5931\u8D25", "<p>\u53EF\u70B9\u51FB\u201C\u5237\u65B0\u201D\uFF0C\u5C1D\u8BD5\u89E3\u51B3\u6B64\u95EE\u9898\u3002</p>", !0),
 new Error("gitee.com \u8BF7\u6C42\u5931\u8D25\u3002" + n);
 case 6:
 return o = new ya(r,t),
