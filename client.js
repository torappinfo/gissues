...
var Origin = script.src.match(/^https:\/\/gissues\.gitee\.io|http:\/\/localhost:\d+/)[0];
var url = Origin + "/Gissues.html";
script.insertAdjacentHTML('afterend', "<div class=\"Gissues\">\n    <iframe class=\"Gissues-frame\" title=\"Comments\" scrolling=\"no\" src=\"" + url + "?" + (0, _deparam.param)(attrs) + "\"></iframe>\n  </div>");
