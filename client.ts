...
if (script === undefined) {
  ...
  script = document.querySelector('script[src^="https://gissues.gitee.io/client.js"],script[src^="https://gissues.gitee.io/client.js"]') as HTMLScriptElement;
}
...
const beaudarOrigin = script.src.match(/^https:\/\/gissues.gitee.\.io|http:\/\/localhost:\d+/)![0];
